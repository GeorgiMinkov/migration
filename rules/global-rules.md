...
3. **Resource Lifecycle Awareness**:
   ...
   - Use language-specific best practices (e.g., NodeJS sepcific for /backend and ReactJS specific for /frontend).

## Documentation
1. **Documentation as Code**:
   - Maintain documentation in a structured format (e.g., Markdown).
   - Use tools like Javadoc to generate documentation from code comments.
   - Ensure documentation is up-to-date and consistent with the codebase.
2. **Clear and Concise Documentation**:
   - Write documentation that is easy to understand and navigate.
   - Use clear and concise language to explain complex concepts.
   - Use examples and diagrams to help explain complex concepts.
3. **Documentation Maintenance**:
   - Maintain documentation in a structured format (e.g., Markdown).
   - Use tools like Javadoc to generate documentation from code comments.
   - Ensure documentation is up-to-date and consistent with the codebase.
4. ** Always validate if README needs to be updated after code change**: